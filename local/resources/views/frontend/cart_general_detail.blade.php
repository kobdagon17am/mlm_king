                                ...
                                <div class="row">
                                    <div class="col-xl-5 col-lg-12 col-md-12 col-sm-12">
                                        <div class="tab-content pt-0">
                                            <div class="tab-pane show" id="product-1-item">
                                                <img src="assets/img/product-detail-1.jpg" alt=""
                                                    class="img-fluid mx-auto d-block rounded">
                                            </div>
                                            <div class="tab-pane" id="product-2-item">
                                                <img src="assets/img/product-detail-2.jpg" alt=""
                                                    class="img-fluid mx-auto d-block rounded">
                                            </div>
                                            <div class="tab-pane" id="product-3-item">
                                                <img src="assets/img/product-detail-3.jpg" alt=""
                                                    class="img-fluid mx-auto d-block rounded">
                                            </div>
                                            <div class="tab-pane active" id="product-4-item">
                                                <img src="assets/img/product-detail-4.jpg" alt=""
                                                    class="img-fluid mx-auto d-block rounded">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xl-7 col-lg-12 col-md-12 col-sm-12">
                                        <div class="mt-3 mt-xl-0">
                                            <a href="{{ route('CartGeneral') }}" class="text-primary mb-3 d-block"><i
                                                    class="las la-arrow-left"></i> หน้ารายการสินค้า</a>
                                            <h2 class="mb-3 text-black strong">Full Sleeve Cotton Shirt with Collar</h2>
                                            <h3 class="mb-3">
                                                <b>฿ 1,000</b>
                                                <span class="text-success ml-2">(50PV)</span>
                                            </h3>
                                            <p class="text-muted mb-4"><b>รายละเอียดสินค้า:</b> There are many variations of passages of shirt
                                    ...
                                    <ul class="nav nav-tabs  mb-3" id="lineTab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="underline-reviews-tab" data-toggle="tab"
                                                ...
                                                aria-controls="underline-reviews" aria-selected="false">Reviews</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="underline-faqs-tab" data-toggle="tab"
                                                href="#underline-faqs" role="tab" aria-controls="underline-faqs"
                                                aria-selected="true">FAQs</a>
                                        </li>
                                    </ul>
                                    <div class="tab-content" id="lineTabContent-3">
                                        <!-- SPECIFICATION -->
                                        <div class="tab-pane fade show active" id="underline-specification"
                                            role="tabpanel" aria-labelledby="underline-specification-tab">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p class="text-muted"><i
                                                                    class="lar la-check-circle"></i>Perfect for summer
                                                                outfit</p>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                ...
                                                <div class="col-md-4 mb-4">
                                                    <div class="single-review">
                                                        <div class="d-flex align-items-center mb-2">
                                                            <span class="badge badge-success-teal mr-3">5 <i
                                                                    class="las la-star"></i></span>
                                                            <span class="text-dark strong">Awesome Shirt</span>
                                                        </div>
                                                        <h6 class="font-13 text-muted mb-0">Very nice product. I want to
                                                            buy more.</h6>
                                                        <p class="font-12 text-muted mb-0">- Jonathan Williamson <span
                                                                class="font-10">(12 Aug 2020)</span></p>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 mb-4">
                                                    <div class="single-review">
                                                        <div class="d-flex align-items-center mb-2">
                                                            <span class="badge badge-danger mr-3">2 <i
                                                                    class="las la-star"></i></span>
                                                            <span class="text-dark strong">Not So good</span>
                                                        </div>
                                                        <h6 class="font-13 text-muted mb-0">I didn't like it personally.
                                                            Sad with quality</h6>
                                                        <p class="font-12 text-muted mb-0">- Buli Shinomo <span
                                                                class="font-10">(18 Jun 2020)</span></p>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 mb-4">
                                                    <div class="single-review">
                                                        ...
                                                        <h6 class="font-13 text-muted mb-0">Super nice product. I want to
                                                            buy more.</h6>
                                                        <p class="font-12 text-muted mb-0">- Dhigmandy <span
                                                                class="font-10">(08 Jul 2020)</span></p>
                                                    </div>
                                                </div>
                                                <div class="col-md-4 mb-4">
                                                    <div class="single-review">
                                                        <div class="d-flex align-items-center mb-2">
                                                            <span class="badge badge-warning mr-3">3 <i
                                                                    class="las la-star"></i></span>
                                                            <span class="text-dark strong">Not Good, Not Bad</span>
                                                        </div>
                                                        <h6 class="font-13 text-muted mb-0">I am not super impressed. but i
                                                            like it</h6>
                                                        <p class="font-12 text-muted mb-0">- Justin Gomez <span
                                                                class="font-10">(20 Apr 2020)</span></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="accordion-group">
                                                        <div class="accordion-heading">
                                                            <a class="accordion-toggle collapsed" data-toggle="collapse"
                                                                ...
                                                                FAQ 1 <span class="float-right"><i
                                                                        class="las la-angle-down"></i></span>
                                                            </a>
                                                        </div>
                                                        <div id="collapseOne" class="accordion-body collapse">
                                                            <div class="accordion-inner">
                                                                There are many variations of passages of FAQ available, but
                                                                the majority have suffered alteration in some form, by
                                                                injected humour, or randomised words which don't look even
                                                                slightly believable. If you are going to use a passage of
                                                                FAQ, you need to be sure there isn't anything embarrassing
                                                    ...
                                                    <div class="accordion-group">
                                                        <div class="accordion-heading">
                                                            <a class="accordion-toggle collapsed" data-toggle="collapse"
                                                                ...
                                                                FAQ 2 <span class="float-right"><i
                                                                        class="las la-angle-down"></i></span>
                                                            </a>
                                                        </div>
                                                    ...
                                                    <div class="accordion-group">
                                                        <div class="accordion-heading">
                                                            <a class="accordion-toggle collapsed" data-toggle="collapse"
                                                                ...
                                                                FAQ 3 <span class="float-right"><i
                                                                        class="las la-angle-down"></i></span>
                                                            </a>
                                                        </div>
                                                    ...
                                                    <div class="accordion-group">
                                                        <div class="accordion-heading">
                                                            <a class="accordion-toggle collapsed" data-toggle="collapse"
                                                                ...
                                                                FAQ 4 <span class="float-right"><i
                                                                        class="las la-angle-down"></i></span>
                                                            </a>
                                                        </div>
