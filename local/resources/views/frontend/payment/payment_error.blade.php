                    ...
                    <li>
                        <div class="page-header">
                            <nav class="breadcrumb-one" aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item active" aria-current="page"><span>ชำระเงินไม่สำเร็จ</span>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-xl-12">
                                <div class="coming-soon-bottom">
                                    <h1 class="text-danger">ชำระเงินไม่สำเร็จ</h1>
                                    <p class="mb-0 mt-3">ชำระเงินไม่สำเร็จกรุณาทำรายการไหม่อีกครั้งหรือติดต่อเจ้าหน้าที่</p>
