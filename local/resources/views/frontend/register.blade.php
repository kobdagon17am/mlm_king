                                                                ...
                                                                <div class="form-group">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="bank_name" class="form-control"
                                                                            ...
                                                                            <option value="{{$value_bank->bank_name}}">{{$value_bank->bank_name}}</option>
                                                                            @endforeach
                                                            ...
                                                            <div class="widget-content widget-content-area">
                                                                <div class="table-responsive">
                                                                    <table class="table table-bordered mb-4">
                                                                        ...
                                                                        <tbody>
                                                                            <?php
                                                                            $product = \App\Http\Controllers\Frontend\CartGeneralController::product_detail('1');
                                                                ...
                                                                <div class="profile-shadow w-100 mt-4">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <ul class="nav nav-tabs mb-3" id="animateLine"
                                                                            ...
                                                                            <li class="nav-item">
                                                                                <a class="nav-link"
                                                                                    id="animated-underline-messages-tab"
                                                                                    data-toggle="tab"
                                                                                    href="#animated-underline-messages"
                                                                                    role="tab"
                                                                                    aria-controls="animated-underline-messages"
                                                                                    aria-selected="false">
                                                                                    บัตรเครดิต</a>
                                                                            ...
                                                                            <li class="nav-item">
                                                                                <a class="nav-link"
                                                                                    ...
                                                                                    role="tab"
                                                                                    aria-controls="animated-underline-home"
                                                                                    aria-selected="false"> บัตรเกษตรสุขใจ</a>
                                                                            </li>
                                                                        </ul>
                                                                        <div class="tab-content"
                                                                            ...
                                                                            <div class="tab-pane fade"
                                                                                id="animated-underline-messages"
                                                                                role="tabpanel"
                                                                                aria-labelledby="animated-underline-messages-tab">
                                                                                <div class="text-center">
                                                                                    <img src="http://localhost/mlm_king/frontend/assets/img/credit-logo.png"
                                                                                        class="img-fluid mx-auto rounded"
                                                                                        alt="Responsive image">
                                                                                </div>
                                                                                ...
                                                                                <div class="col-md-12">
                                                                                    <div
                                                                                        ...
                                                                                        <button type="button"
                                                                                            name="make_payment"
                                                                                            onclick="submit_confirm(2)"
                                                                                            class="action-button btn btn-primary"
                                                                                            value="craditcart">ชำระด้วยบัตรเครดิต
                                                                                        </button>
                                                                            ...
                                                                            <div class="tab-pane fade"
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-md-6">
                                                                                        <div class="text-center">
                                                                                            <img src="http://localhost/mlm_king/frontend/assets/img/scb.png"
                                                                                                class="img-fluid mx-auto"
                                                                                                alt="Responsive image">
                                                                                            <p class="font-20"><b>xxxx</b>
                                                                                            </p>
                                                                                            <p class="font-13">
                                                                                                ธนาคารไทยพาณิชย์</p>
                                                                                            <p class="font-13">บริษัท
                                                                                                กิ่งทองใบหยก จำกัด</p>
                                                                                        </div>
                                                                                    </div>
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <button type="button"
                                                                                        name="make_payment"
                                                                                        onclick="submit_confirm(3)"
                                                                                        class="action-button btn btn-primary"
                                                                                        value="tranfer">โอนชำระ </button>
                                                                            ...
                                                                            <div class="tab-pane fade"
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <button type="button"
                                                                                        ...
                                                                                        class="action-button btn btn-primary"
                                                                                        value="tranfer">บัตรเกตรสุขใจ </button>
