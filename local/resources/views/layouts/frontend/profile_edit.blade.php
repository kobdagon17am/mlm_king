...
<head>
    ...
    <title>Xato Profile Edit | Xato - Multipurpose Bootstrap Admin Dashboard Template </title>
            ...
            <nav id="sidebar">
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled collapse" id="dashboard" data-parent="#accordionExample">
                            <li class="active">
                    ...
                    <li class="menu">
                        <a href="#pages" data-active="true"  data-toggle="collapse" aria-expanded="true" class="dropdown-toggle">
                            <div class="">
                        ...
                        <ul class="collapse submenu list-unstyled show" id="pages" data-parent="#accordionExample">
                            ...
                            <li class="active">
                                <a data-active="true" href="pages_profile_edit.html"> Profile Edit </a>
                            </li>
                            <li>
                    ...
                    <li class="menu">
                        <a href="https://xatoadmin-demo.web.app/documentation/index.html" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                                ...
                                                <div class="profile-edit-left">
                                                    <div class="tab-options-list">
                                                        <div class="nav flex-column nav-pills mb-sm-0 mb-3   text-center mx-auto" id="v-border-pills-tab" role="tablist" aria-orientation="vertical">
                                                            <a class="nav-link active" id="v-border-pills-general-tab" data-toggle="pill" href="#v-border-pills-general" role="tab" aria-controls="v-border-pills-general" aria-selected="true"><i class="las la-info"></i> General Information</a>
                                                            <a class="nav-link  text-center" id="v-border-pills-about-tab" data-toggle="pill" href="#v-border-pills-about" role="tab" aria-controls="v-border-pills-about" aria-selected="false"><i class="lar la-user"></i> About</a>
                                                            <a class="nav-link  text-center" id="v-border-pills-domain-tab" data-toggle="pill" href="#v-border-pills-domain" role="tab" aria-controls="v-border-pills-domain" aria-selected="false"><i class="las la-graduation-cap"></i> Domain Expertise</a>
                                                            <a class="nav-link  text-center" id="v-border-pills-contact-tab" data-toggle="pill" href="#v-border-pills-contact" role="tab" aria-controls="v-border-pills-contact" aria-selected="false"><i class="las la-phone"></i> Contact</a>
                                                            <a class="nav-link  text-center" id="v-border-pills-social-tab" data-toggle="pill" href="#v-border-pills-social" role="tab" aria-controls="v-border-pills-social" aria-selected="false"><i class="las la-hashtag"></i> Social</a>
                                                            <a class="nav-link  text-center" id="v-border-pills-education-tab" data-toggle="pill" href="#v-border-pills-education" role="tab" aria-controls="v-border-pills-education" aria-selected="false"><i class="las la-university"></i> Education</a>
                                                            <a class="nav-link  text-center" id="v-border-pills-work-tab" data-toggle="pill" href="#v-border-pills-work" role="tab" aria-controls="v-border-pills-work" aria-selected="false"><i class="las la-suitcase"></i> Work Experience</a>
                                                          </div>
                                                    </div>
                                                    <div class="mt-3">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xl-3 col-lg-12 col-md-12">
                                                                    <div class="upload text-center img-thumbnail">
                                                                        <input type="file" id="input-file-max-fs" class="dropify" data-default-file="assets/img/profile-16.jpg" data-max-file-size="2M" />
