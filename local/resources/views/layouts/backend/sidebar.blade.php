            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                ...
                <li class="menu main-single-menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="apps" data-parent="#accordionExample">
                        ...
                        <li>
                            <a href="#pages-companies" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle collapsed"> Companies <i class="las la-angle-right sidemenu-right-icon"></i> </a>
                            <ul class="collapse list-unstyled sub-submenu" id="pages-companies" data-parent="#apps"> 
                                <li>
                        ...
                        <li>
                            <a href="#pages-ecommerce" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle collapsed"> Ecommerce <i class="las la-angle-right sidemenu-right-icon"></i> </a>
                            <ul class="collapse list-unstyled sub-submenu" id="pages-ecommerce" data-parent="#apps"> 
                                <li>
                        ...
                        <li>
                            <a href="#pages-email" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle collapsed"> Email <i class="las la-angle-right sidemenu-right-icon"></i> </a>
                            <ul class="collapse list-unstyled sub-submenu" id="pages-email" data-parent="#apps"> 
                                <li>
                        ...
                        <li>
                            <a href="#pages-notes" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle collapsed"> Notes <i class="las la-angle-right sidemenu-right-icon"></i> </a>
                            <ul class="collapse list-unstyled sub-submenu" id="pages-notes" data-parent="#apps"> 
                                <li>
                        ...
                        <li>
                            <a href="#pages-error" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle collapsed"> Tickets <i class="las la-angle-right sidemenu-right-icon"></i> </a>
                            <ul class="collapse list-unstyled sub-submenu" id="pages-error" data-parent="#apps"> 
                                <li>
                    ...
                    <ul class="collapse submenu list-unstyled" id="pages" data-parent="#accordionExample">
                        <li class="menu">
                            ...
                            <ul class="collapse list-unstyled sub-submenu" id="other_pages_one" data-parent="#pages">
                                ...
                                <li>
                                    <a href="#pages-error" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle collapsed"> Error <i class="las la-angle-right sidemenu-right-icon"></i> </a>
                                    <ul class="collapse list-unstyled sub-sub-submenu" id="pages-error"> 
                                        <li>
                        ...
                        <li class="menu">
                            ...
                            <ul class="collapse list-unstyled sub-submenu" id="forms" data-parent="#components">
                                <li>
                                    ...
                                    <ul class="collapse list-unstyled sub-sub-submenu" id="form-widget" data-parent="#forms"> 
                                        <li>
                                ...
                                <li>
                                    ...
                                    <ul class="collapse list-unstyled sub-sub-submenu" id="form-control" data-parent="#forms"> 
                                        <li>
