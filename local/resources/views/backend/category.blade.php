                                                                ...
                                                                <div class="form-group row">
                                                                    <div class="col-lg-6  mt-2">
                                                                        ...
                                                                        <input type="text" name="category_name" class="form-control"
                                                                            placeholder="หมวดสินค้า" required>
                                                                    </div>
                                                                    <div class="col-lg-6  mt-2">
                                                                        <label><b>หมวดสินค้า (ภาษาอังกฤษ):</b></label>
                                                                        <input type="text" name="category_en_name" class="form-control"
                                                                            placeholder="หมวดสินค้า (ภาษาอังกฤษ)" required>
                                                                    </div>
                                                                    <div class="col-lg-12 mt-2">
                                                                        <label><b>สถานะหมวดสินค้า:</b></label>
                                                                        <select class="form-control" name="category_status" id="product_status">
