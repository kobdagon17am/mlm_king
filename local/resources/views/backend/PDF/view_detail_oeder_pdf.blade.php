        ...
        <thead>
            <tr>
                <th align="left" style="width: 70%;">
                    {{-- <p style="font-size: 10px"> <img src="{{ asset('frontend/assets/img/logo/logo.png') }}" alt="Girl in a jacket" height="85"><br> --}}
                </th>

                <th align="center">
                    <h3 style="font-size: 30px;color: #123d71">ต้นฉบับ</h3>
                </th>
            </tr>
            <tr>
    ...
    <table style="width: 100%;border: 0px solid black;padding: 0px;margin: 0px" border="0">
        <thead class="">
            <tr>
               ...
               <td style="background-color:#a3a3a3;padding-left: 2px; width: 20%;text-align: right"><b style="color: #000;font-size: 14px;margin-left: 5px;margin-top: 0px;">PV</b></td>
        ...
        <tbody>
            ...
            <tr>
                <td colspan="5"><div class="horizontal-line"></div></td>
            </tr>
                 <tr>
                <td> </td>
                <td> </td>
    ...
    <table style="width: 100%;border: 0px;margin: 0px" border="0">
        <thead>
            <tr>
                ...
                <th align="center">
                    <h3 style="font-size: 30px;color: #123d71">สำเนา</h3>
                </th>
            </tr>
            <tr>
