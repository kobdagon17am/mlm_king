                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-2">
                                    <div class="widget widget-chart-one">
                                        <div class="widget-heading">
                                            <h5 class="">รายการสินค้าล่าสุด</h5>
                                        ...
                                        <div class="widget-content">
                                            <div class="d-flex flex-column">
                                                <div class="media recent-items w-100 align-items-center mt-2 mb-4">
                                                    <img src="{{ asset('backend/assets/img/product-1.jpg') }}"
                                                        alt="">
                                                    <div class="media-body ml-4 mt-sm-3">
                                                        <h5 class="mb-1">หูฟัง</h5>
                                                        <p>05 Jul 2023</p>
                                                    </div>
                                                    <a class="badge badge-info text-white mr-2">กำลังดำเนินการ</a>
                                                    {{-- <a class="badge badge-success-teal text-white mr-2">สำเร็จ</a>
                                                <a class="badge badge-warning text-white d-none d-lg-block">กำลังดำเนินการ</a> --}}
                                                </div>
                                                <div class="media recent-items w-100 align-items-center mb-4">
                                                    <img src="{{ asset('backend/assets/img/product-2.jpg') }}"
                                                        alt="">
                                                    <div class="media-body ml-4 mt-sm-3">
                                                        <h5 class="mb-1">กล้อง</h5>
                                                        <p>12 Jul 2023</p>
                                                    </div>
                                                    <a class="badge badge-success text-white mr-2">สำเร็จ</a>

                                                </div>
                                                <div class="media recent-items w-100 align-items-center mb-4">
                                                    <img src="{{ asset('backend/assets/img/product-3.jpg') }}"
                                                        alt="">
                                                    <div class="media-body ml-4 mt-sm-3">
                                                        <h5 class="mb-1">โน๊ตบุค
                                                        </h5>
                                                        <p>12 Jul 2023</p>
                                                    </div>
                                                    <a class="badge badge-danger text-white mr-2">ยกเลิก</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6 mb-2">
                                    <div class="widget widget-chart-one">
                                        <div class="widget-heading">
                                            <h5 class="">รายการสินค้ายอดนิยม</h5>
                                        </div>
                                        <div class="widget-content mt-4">
                                            <h6 class="text-center"><b>อันดับ 1</b> (฿ 5,458)</h6>
                                            <img src="{{ asset('backend/assets/img/product-1.jpg') }}"
                                                class="rounded-circle avatar-xl img-thumbnail m-auto object-cover" />
                                            {{-- <p class="text-center">$5,458</p> --}}
                                            <div class="d-flex justify-content-center mb-4">
                                                <span class="badge badge-success font-size-12"> + 25% </span>
                                                <span class="ml-2 text-truncate">เทียบจากเดือนที่แล้ว</span>
                                            </div>
                                            <h6 class="text-center"><b>อันดับ 2</b> (฿ 5,458)</h6>
                                            <img src="{{ asset('backend/assets/img/product-4.jpg') }}"
                                                class="rounded-circle avatar-xl img-thumbnail m-auto object-cover" />
                                            <div class="d-flex justify-content-center mb-4">
                                    ...
                                    {{-- <div class="widget widget-chart-two">
                                        ...
                                        <div class="widget-content mt-4">
                                            <img src="{{ asset('backend/assets/img/product-1.jpg') }}" class="rounded-circle avatar-md img-thumbnail m-auto object-cover"/>
                                            ...
                                            <img src="{{ asset('backend/assets/img/product-4.jpg') }}" class="rounded-circle avatar-md img-thumbnail m-auto object-cover"/>
